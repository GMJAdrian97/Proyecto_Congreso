...
<table class="table table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>  
                    <lu>
                    <i class="btn btn-success bi-pencil"><a href="CtrlConferencia.php?accion=modify&id_conferencia=<?php echo $dato['id_conferencia']; ?>">Modificar</a></i>
                    <i class="btn btn-danger bi bi-trash"><a href="CtrlConferencia.php?accion=delete&id_conferencia=<?php echo $dato['id_conferencia']; ?>">Eliminar</a></i>
                    </lu>
                </td>
            </tr>
