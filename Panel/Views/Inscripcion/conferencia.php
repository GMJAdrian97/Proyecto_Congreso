...
<table class="table table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>  
                    <lu>
                    <i class="btn btn-success bi-pencil"><a href="CtrlInscripcion.php?accion=participante&id_evento=<?php echo $dato['id_evento']; ?>&id_conferencia_p=<?php echo $dato['id_conferencia_p']; ?>&id_conferencia=<?php echo $dato['id_conferencia']; ?>">Modificar</a></i>
                    </lu>
                </td>
            </tr>
