...
<table class="table table-dark">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>  
                    <lu>
                    <i class="btn btn-danger bi-pencil"><a href="CtrlInscripcion.php?accion=participante&id_evento=<?php echo $id_evento; ?>&id_conferencia_p=<?php echo $id_conferencia_p; ?>&id_conferencia=<?php echo $id_conferencia; ?>&id_participante=<?php echo $dato['id_participante'];?>&accion_participante=eliminar">Eliminar</a></i>
                    </lu>
                </td>
            </tr>
